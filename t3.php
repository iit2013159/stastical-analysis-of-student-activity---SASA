...
$row = mysql_fetch_array(mysql_query("select Monday.11 AS bh1, Tuesday.11 AS bh1, Wednesday.11 AS bh1, Thursday.11 AS bh1, Friday.11 AS bh1, Saturday.11 AS bh1, Sunday.11 AS bh1 FROM Monday, Tuesday, Wednesday, Thursday, Friday, Saturday, Sunday"));;
