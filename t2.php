...
$row = mysql_fetch_array(mysql_query("select Monday.10 AS bh1, Tuesday.10 AS bh1, Wednesday.10 AS bh1, Thursday.10 AS bh1, Friday.10 AS bh1, Saturday.10 AS bh1, Sunday.10 AS bh1 FROM Monday, Tuesday, Wednesday, Thursday, Friday, Saturday, Sunday"));;
