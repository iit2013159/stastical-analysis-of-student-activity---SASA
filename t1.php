...
$row = mysql_fetch_array(mysql_query("select Monday.9 AS bh1, Tuesday.9 AS bh1, Wednesday.9 AS bh1, Thursday.9 AS bh1, Friday.9 AS bh1, Saturday.9 AS bh1, Sunday.9 AS bh1 FROM Monday, Tuesday, Wednesday, Thursday, Friday, Saturday, Sunday"));;
