...
$row = mysql_fetch_array(mysql_query("select Monday.12 AS bh1, Tuesday.12 AS bh1, Wednesday.12 AS bh1, Thursday.12 AS bh1, Friday.12 AS bh1, Saturday.12 AS bh1, Sunday.12 AS bh1 FROM Monday, Tuesday, Wednesday, Thursday, Friday, Saturday, Sunday"));;
